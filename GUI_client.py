...
class GuiClient:
    ...
    def __init__(self, window_context):
        ...
        # teoretic ar putea fi BoleeanVar, dar e un detaliu minor
    ...
    def load_options(self):
        ...
        # asta se intampla automat in constructor
        # if self.MESSAGE_TYPE.get():
        #     options += DHCP_MESSAGE_TYPE_OPTION
        ...
        #         raise ValueError
        #     discover.add_option(Packet.Packet.IP_ADDRESS_LEASE_TIME_ADDRESS_OPTION,
        #                         bytes(int(self.lease_entry.get()).to_bytes(4, 'big')))
        ...
        # se intampla deja in Packet.pack
        # if self.END.get():
        #     options += END_OPTION
    ...
    def run(self):
        ...
        # reordonat optiunile intr-o ordine mai logica
        ...
        # nu cred ca clientul ar trebui sa-si aleaga lease time-ul
        ...
        # nu cred ca server identifier are legatura cu clientul
        ...
        #                       command=self.disable_request_list)
        ...
        # opt5_label.grid(row=4, column=1, sticky='w')
        # self.lease_entry.config(state="disabled")
        # self.lease_entry.grid(row=4, column=2)
